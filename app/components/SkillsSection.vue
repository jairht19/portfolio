  ...
  <div class="grid gap-8 md:grid-cols-4 text-sm">
    <div>
      ...
      <ul class="space-y-1 text-[var(--color-text-soft)]">
        ...
        <li>SuiteFlow, WMS y automatización operativa</li>
        <li>SDF y despliegue de SuiteApps</li>
        <li>Reportes fiscales (DIOT · Desglose de impuestos)</li>
      </ul>
    </div>
    ...
    <div>
      ...
      <ul class="space-y-1 text-[var(--color-text-soft)]">
        ...
        <li>Tailwind CSS y FreeMarker</li>
        <li>Integraciones con AWS (S3, Lambdas ligeras)</li>
      </ul>
    </div>
    ...
    <div>
      ...
      <ul class="space-y-1 text-[var(--color-text-soft)]">
        ...
        <li>Biome / linters y estándares</li>
    ...
    <div>
      ...
      <ul class="space-y-1 text-[var(--color-text-soft)]">
        ...
        <li>Responsabilidad y ownership</li>
